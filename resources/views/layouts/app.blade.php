...
<head>
    ...
    <script src="dist/js/adminlte.js"></script>c
    ...
    <div id="app">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="{{asset('dist/img/USU.jfif')}}" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
            ...
            <footer class="main-footer">
                <!-- NO QUITAR -->
                <strong> Desarrollado por: |Kevin Morera Rodriguez|Luis Diego Barrantes Herrera|Roy Rodriguez Barboza
